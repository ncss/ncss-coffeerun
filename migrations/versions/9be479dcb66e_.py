...
def upgrade():
    ...
    op.drop_table(u'sessions')
    # ### end Alembic commands ###


def downgrade():
    # ### commands auto generated by Alembic - please adjust! ###
    op.create_table(u'sessions',
    sa.Column(u'id', sa.INTEGER(), nullable=False),
    sa.Column(u'session_id', sa.VARCHAR(length=256), nullable=True),
    sa.Column(u'data', sa.BLOB(), nullable=True),
    sa.Column(u'expiry', sa.DATETIME(), nullable=True),
